========================================================================
    KONSOLENANWENDUNG: openGl_try3-Projektübersicht
========================================================================

Diese openGl_try3-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die openGl_try3-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen openGl_try3.pch sowie eine vorkompilierte 
